...
<div class="container form">
    <div class="input-judul ">
        <h4>Nama</h4>
        <input type="text" placeholder="Masukkan nama anda" required style="padding-left: 20px;">
    </div>
    <div class="input-judul ">
        <h4>Email</h4>
        <input type="text" placeholder="Masukkan email anda" required style="padding-left: 20px;">
    </div>
    <div class="input-judul ">
        <h4>Pesan Dan Saran</h4>
        <textarea style="width: 912px; height: 263px; border-radius: 15px; margin-bottom: 35px; padding-left: 20px;" placeholder="Masukkan Pesan dan Saran Anda" required ></textarea>
    </div>
